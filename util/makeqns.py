...
for i in range(0,12):
	...
	for ans in lines[1:]:
		...
		if qtype == "radio":
			...
			template.append('<label class="label_check '+"qn"+str(i)+'" for="'+radiodet+'"><input name="sample-radio-'+str(i)+asuffix+'" id="'+radiodet+'" value="'+str(choice)+'" type="checkbox" />'+ans+'</label>') 
		choice = choice + 1
